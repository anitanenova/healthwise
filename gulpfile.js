...
gulp.task("sass", function () {
  return (
    gulp
      .src(paths.source.sass + "master.scss")
...
gulp.task("scripts", function () {
  return gulp
    .src([
      paths.source.scripts + "/vendor/sample-library.js",
      paths.source.scripts + "vendor/sample-library2.js",
    ])
...
gulp.task("watch", function () {
  ...
  gulp
    .watch(paths.source.sass + "**/*.scss", gulp.series("sass"))
    .on("change", browserSync.reload);
  gulp
    .watch(paths.destination.css + "master.css", gulp.series("cssmin"))
    .on("change", browserSync.reload);
  gulp
    .watch(paths.source.scripts + "**/*.js", gulp.series("scripts"))
    .on("change", browserSync.reload);
});
